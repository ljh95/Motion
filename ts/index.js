...
function deleteCurrentArticle(e) {
    ...
    if (elem.dataset.type === 'IMAGE' || elem.dataset.type === 'VIDEO')
        article = (_b = (_a = elem.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement;
    else {
        article = (_c = elem.parentElement) === null || _c === void 0 ? void 0 : _c.parentElement;
    }
    if (article) {
